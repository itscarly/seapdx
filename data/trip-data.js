window.TRIP_DATA = {
  ...
  budget: {
    ...
    categories: [
      { name: "Transportation", amount: 141.20, note: "Seattle ORCA all-day pass ($6 first ride per day, $0 subsequent rides same day) and Portland TriMet/Hop all-day pass ($6 first ride per day, $0 subsequent rides same day) as the primary model for Nov 1-9 local transit, replacing per-leg fare pricing. Non-ORCA fares (Washington State Ferries Bainbridge round-trip $12, Amtrak Cascades SEA-PDX $48, POINT NorthWest Cannon Beach round-trip $40) are tracked separately and unchanged. Sep 13, 2026 update removed the Shonen Tattoo/Milwaukie transit and Best Buy Northgate fit-check routing. Sep 25, 2026 update adds the Columbia River Gorge Waterfall Shuttle Tour as a paid admission item, with shuttle pickup/check-in tracked in the Day 8 schedule rather than as a separate transit fare." },
      ...
      { name: "Entrance fees", amount: 135.04, note: "Paid attractions in the synced route. Columbia Center Sky View Observatory Elite Experience is $52.50. Added Sep 25, 2026: Columbia River Gorge Waterfall Shuttle Tour moved to Nov 8 at 10:30 AM, $82.54 total including the $79 adult ticket, $2 Trailkeepers of Oregon donation, taxes, and fees. Sailing Seattle remains removed; Seattle Great Wheel stays photo-only with no entrance fee." },
  ...
  itinerary: [
    ...
    },
    {
      ...
      date: "Sun, Nov 8",
      city: "Portland",
      title: "Columbia River Gorge waterfall tour + Cartopia food carts",
      theme: "Waterfall shuttle tour, late food carts, and easy recovery before flight day",
      dayTotal: 59,
      weatherPlan: "Indoor-friendly, low-effort day by design -- no hiking or long outdoor exposure needed.",
      segments: [
        { label: "Morning", items: [
          { time: "8:00 AM", name: "Wake + prep for waterfall tour", type: "rest", neighborhood: "Hotel Vance Portland", duration: "60 min", cost: 0, notes: "Earlier start for the 10:30 AM Columbia River Gorge Waterfall Shuttle Tour." },
          { time: "9:00 AM", name: "Travel to Sasquatch Adventures + tour check-in", type: "transit", neighborhood: "Portland -> Columbia River Gorge", duration: "90 min", cost: 0, notes: "Arrive 15 minutes early to check in and look around at the Sasquatch Adventures store before the 10:30 AM tour.", route: "https://www.google.com/maps/search/Sasquatch+Adventures+Store+Columbia+River+Gorge", mapFrom: "Hotel Vance Portland", mapTo: "Sasquatch Adventures Store" },
          { time: "10:30 AM", name: "Columbia River Gorge Waterfall Shuttle Tour", type: "activity", neighborhood: "Columbia River Gorge", location: "Sasquatch Adventures Store", duration: "2.5 hrs", cost: 82.54, website: "https://sasquatchshuttle.com/waterfall-tour/", payment: "Paid booking -- total $82.54", detailText: `Waterfall shuttle tour moved to Nov 8, 2026 at 10:30 AM so Nov 7 stays focused on Portland Saturday Market.\nAccessible site: https://sasquatchshuttle.com/waterfall-tour/\nTitle: Columbia River Gorge Waterfall Shuttle Tour.\nReceipt total: $82.54, including Adult (12 & Up) ticket $79.00, Trailkeepers of Oregon Donation $2.00, and taxes/fees.\nTour format: narrated shuttle through the Columbia River Gorge Waterfall Corridor, small-group maximum 20 guests, with expert narration and stops at must-see Gorge attractions. Expect about 15 minutes at each stop except Multnomah Falls.\nHighlights: Multnomah Falls, Gorge history and nature, 250+ five-star-review positioning, dog-friendly operator, and 20% off at the Sasquatch Adventures store.\nCancellation: free cancellation up to 48 hours in advance for a full refund.\nImportant: arrive 15 minutes early for check-in. Activity copy also mentions peak-season 8:30 AM and 2:30 PM departures; itinerary uses the traveler-requested 10:30 AM time and Nov 8 placement.`, route: "https://www.google.com/maps/search/Columbia+River+Gorge+Waterfall+Shuttle+Tour+Sasquatch+Adventures", mapFrom: "Sasquatch Adventures Store", mapTo: "Multnomah Falls, Oregon" }
        ]},
        { label: "Daytime", items: [
          { time: "1:00 PM", name: "Return from waterfall tour", type: "transit", neighborhood: "Columbia River Gorge -> Portland", duration: "75 min", cost: 0, notes: "Return buffer after the 2.5-hour narrated shuttle tour." },
          { time: "2:15 PM", name: "Transit to Cartopia food carts", type: "transit", neighborhood: "Hotel Vance -> SE Hawthorne (Cartopia)", duration: "20 min", cost: 6, notes: "Short trip out for a late Cartopia visit. First TriMet-system ride of Day 8 -- flat $6 day-pass charge." },
          { time: "2:45 PM", name: "Cartopia food cart pod late lunch", type: "meal", neighborhood: "SE Hawthorne", location: "Cartopia Food Carts, 1207 SE Hawthorne Blvd, Portland, OR 97214", duration: "75 min", cost: 50, website: "https://www.cartopiapdx.com/carts", payment: "Cash preferred", detailText: `Portland's largest food cart cluster, visited after the waterfall tour.\nCart directory: https://www.cartopiapdx.com/carts\nORDER: Bing Mi (Potato Champion's poutine cart neighbor) or Pyro Pizza's wood-fired pizza by the slice, plus a BKK pad thai order from Bing Bing if you want to split two carts.\nEstimated cost: $50.\nPayment: Bring cash; not all carts accept cards.` }
        ]},
        { label: "Evening", items: [
          { time: "4:00 PM", name: "Transit back to Hotel Vance", type: "transit", neighborhood: "SE Hawthorne -> Hotel Vance", duration: "20 min", cost: 0, notes: "Return transfer. Cost $0 -- covered by the day's $6 TriMet pass." },
          { time: "4:30 PM", name: "Hotel Vance rest afternoon", type: "rest", neighborhood: "Hotel Vance Portland", duration: "3.5 hrs", cost: 0, notes: "Keep the rest of the day unstructured -- rest, recover, pack for tomorrow's flight." },
